    ...
    return (
        <div className='flex justify-between items-center px-4 py-2'>
            <div className='flex items-center'>
                <BsChatSquareDots size={30} className='text-[var(--primary-dark)] mr-2'></BsChatSquareDots>
                <h1 className='text-xl font-bold text-gray-700'>EXPLORE</h1>
            </div>
            <div className='flex'>
                ...
                <div className='hidden md:flex items-center px-6'>
                    ...
                    <p className='text-sm text-gray-700'>1-23-456-7890</p>
                </div>
